...
df=pd.read_csv("/Users/macbookair/Downloads/Prototype.csv")
...
tr = pd.read_csv("/Users/macbookair/Downloads/Prototype-1.csv")
...
if __name__ == '__main__':
    ...
    w2 = Label(root, justify=LEFT, text="Bootcamp AI - Week 2 - Disease Predictor using Machine Learning", fg="white", bg="grey")
    ...
    S1Lb = Label(root, text="Symptom 1", fg="white", bg="grey")
    S1Lb.config(font=("Times", 20, "bold italic"))
    S1Lb.grid(row=7, column=0, pady=10, sticky=W)

    S2Lb = Label(root, text="Symptom 2", fg="white", bg="grey")
    S2Lb.config(font=("Times", 20, "bold italic"))
    S2Lb.grid(row=8, column=0, pady=10, sticky=W)

    S3Lb = Label(root, text="Symptom 3", fg="white", bg="grey")
    S3Lb.config(font=("Times", 20, "bold italic"))
    S3Lb.grid(row=9, column=0, pady=10, sticky=W)

    S4Lb = Label(root, text="Symptom 4", fg="white", bg="grey")
    S4Lb.config(font=("Times", 20, "bold italic"))
    S4Lb.grid(row=10, column=0, pady=10, sticky=W)

    S5Lb = Label(root, text="Symptom 5", fg="white", bg="grey")
    S5Lb.config(font=("Times", 20, "bold italic"))
    S5Lb.grid(row=11, column=0, pady=10, sticky=W)

    lrLb = Label(root, text="DecisionTree", fg="white", bg="grey")
    lrLb.config(font=("Times", 25, "bold italic"))
    lrLb.grid(row=15, column=0, pady=10, sticky=W)

    destreeLb = Label(root, text="RandomForest", fg="white", bg="grey")
    destreeLb.config(font=("Times", 25, "bold italic"))
    destreeLb.grid(row=17, column=0, pady=10, sticky=W)

    ranfLb = Label(root, text="NaiveBayes", fg="white", bg="grey")
    ...
    t1 = Text(root, height=2, width=30, bg="grey", fg="white")
    t1.config(font=("Times", 15, "bold italic"))
    t1.grid(row=15, column=1, padx=5)

    t2 = Text(root, height=2, width=30, bg="grey", fg="white")
    t2.config(font=("Times", 15, "bold italic"))
    t2.grid(row=17, column=1, padx=5)

    t3 = Text(root, height=2, width=30, bg="grey", fg="white")
